...
public class MainPanelNames extends FormEditorNames {
	public static final String ID_ABEILLEFORMS_FILE = "abeilleforms.file";
	public static final String ID_ABEILLEFORMS_EDIT = "abeilleforms.edit";
	public static final String ID_ABEILLEFORMS_COLUMN = "abeilleforms.column";
	public static final String ID_ABEILLEFORMS_ROW = "abeilleforms.row";
	public static final String ID_ABEILLEFORMS_FORM = "abeilleforms.formv";
	public static final String ID_ABEILLEFORMS_TOOLS = "abeilleforms.tools";
	public static final String ID_ABEILLEFORMS_HELP = "abeilleforms.help";
